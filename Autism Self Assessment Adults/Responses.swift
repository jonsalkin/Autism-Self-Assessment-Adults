...
// Array of responses to all 50 questions in the active, current survey being completed by the user. This will be emptied after each completed
...
var resultsDictionary: [Date: Int] = [:]
