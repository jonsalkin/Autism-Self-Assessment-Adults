...
struct AutismQuotientResponses {
    ...
    var description: String {
        return "Date: \(resultsDictionaryAQ.keys)\nScore: \(resultsDictionaryAQ.values) out of 50"
    }
}

var autismQuotientResponses = AutismQuotientResponses()
